...
for trial_index,trial_samples in enumerate(trial_event_data):
    ...
    # C.
    # Plot the sample traces for x and y gaze positions seperately for each eye
    # using two sub plots.
    #
    ...
    fig.suptitle("Eye Sample Data For Trial Index %d"%(trial_index+1))
    ...
    #
    right_axis = fig.add_subplot(2,1,2,sharex=left_axis)
